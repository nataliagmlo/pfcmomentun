...
describe Momentum do
  	...
  	describe "#calculate_influences" do
	    ...
	    it "calculate velocity and acceleration for users with equal number of subscribers and more number of mentions" do
	    	...
	    	period = [13,"Jun",2014,11,250,5500,150,80]
			...
			users = []
	      	u1 = create_user u, Time.new(2014,"Jun",13, 9, 00, 00, "+00:00")
	      	users << u1
			...
			if u.has_key? 'Error'
	      	...
	      	u2 = create_user u, Time.new(2014,"Jun",13, 11, 48, 00, "+00:00")
	      	users << u2
    ...
    describe "#calculate_influences" do
	    ...
	    it "calculate velocity and acceleration for users with equal number of mentions and less number of subscribers" do
	    	...
	    	period = [13,"May",2014,11,250,5500,150,80]
	    	prepare_previous_period(period)
			...
			users = []
	      	u1 = create_user u, Time.new(2014,"May",13, 9, 00, 00, "+00:00")
	      	users << u1
			...
			if u.has_key? 'Error'
	      	...
	      	u2 = create_user u, Time.new(2014,"May",13, 9, 00, 00, "+00:00")
	      	users << u2
    ...
    describe "#calculate_influences" do
	    ...
	    it "calculate velocity and acceleration for users with equal number of mentions and followers, previous period more number of mentions" do
	    	...
	    	period = [13,"Feb",2014,11,250,5500,150,80]
	    	prepare_previous_period(period)
			...
			users = []
	      	u1 = create_user u, Time.new(2014,"Feb",13, 10, 00, 00, "+00:00")
	      	users << u1

	      	m = Momentum.new
	      	m.calculate_influences(users, "Wed Feb 13 12:08:40 +0000 2014")

	      	users = []

	      	period = [13,"Jan",2014,11,850,5500,150,80]
	    	prepare_previous_period(period)
			...
			if u.has_key? 'Error'
	      	...
	      	u2 = create_user u, Time.new(2014,"Jan",13, 10, 00, 00, "+00:00")
	      	users << u2
