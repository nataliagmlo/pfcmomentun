...
require_relative '../../lib/client/USMFParser'

describe USMFParser do
  ...
  describe "parse_users_mentions" do
    it "parses users mentions on the tweet" do
      ...
      p.parse_users_mentions status, "Wed Jun 11 12:08:40 +0000 2012"
