...
namespace :tweets do
	...
	desc "Calculates accelerations"
	def calculate_acceletaions user_mention

		previous_period = Period.get_previous_period
		current_period	= Period.get_current_period

		current_period.total_audience += 1
		...
		#Cómo y dónde se almacena las menciones del usuario en un periodo??
